...
function TaskInspectorForm({ onClose, task }: TaskInspectorProps) {
  ...
  return (
    <EntityInspector onClose={onClose} title={task.title}>
...
export function TaskInspector(props: TaskInspectorProps) {
  return <TaskInspectorForm key={props.task.id} {...props} />
}
